...
const FieldSummary: React.FC<FieldSummaryProps> = ({
  ...
  const [editValues, setEditValues] = useState({
    ...
    pv_size: field.pv_size !== undefined && field.pv_size !== null ? 
      (typeof field.pv_size === 'string' ? field.pv_size : field.pv_size.toString()) : "",
              ...
              <TableRow>
                ...
                <TableCell className="p-2">
                  {isEditing ? (
                    ...
                    <span>{typeof field.pv_size === 'string' ? Number(field.pv_size).toFixed(2) : Number(field.pv_size).toFixed(2)} MW</span>
                  ) : (
